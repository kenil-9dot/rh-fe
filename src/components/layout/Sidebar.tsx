...
export default function Sidebar({
  ...
  return (
    <>
      ...
      />
      <aside
        className={`fixed z-50 lg:z-0 lg:static left-0 top-0 h-full lg:h-screen w-72 bg-gradient-to-b from-[#0B0B16] via-[#0E0E1A] to-[#0B0B16] text-slate-300 flex flex-col transition-transform duration-300 ${open ? "translate-x-0" : "-translate-x-full"
          } lg:translate-x-0`}
        aria-label="Sidebar"
      >
        {/* Logo */}
